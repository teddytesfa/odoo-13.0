...
odoo.define('crnd_wsd.tour_request_new_priority_complex_star', function (require) {
    'use strict';

    var tour = require('web_tour.tour');

    tour.register('crnd_wsd_tour_request_new_complex_star', {
        test: true,
        url: '/requests/new',
    }, [
        {
        ...
        },
        {
            ...
            trigger: "label[for='impact_priority_2']",
        },
        {
            content: "Select request urgency priority",
            trigger: "label[for='urgency_priority_1']",
        },
        {
