...
odoo.define('crnd_wsd.tour_request_new_priority_selection', function (require) {
    'use strict';

    var tour = require('web_tour.tour');

    tour.register('crnd_wsd_tour_request_new_selection', {
        test: true,
        url: '/requests/new',
    }, [
        {
        ...
        },
        {
            ...
            trigger: "select[name='request_priority']",
            run: function () {
                $("#request_priority").val('4');
            },
        },
        {
